...
class Genesis_Hero {
	...
	public function title() {
		...
		} elseif ( is_front_page() || is_home() && is_active_sidebar( 'front-page-1' ) ) {
			//$title = get_the_title( get_option( 'page_on_front' ) );
			
			genesis_widget_area( 'hero-image', array(
			'before' => '<div id="hero-image" class="hero-image"><div class="flexible-widgets widget-area"><div class="wrap">',
			'after'  => '</div></div></div>',
			) );
