...
function ck_footer_credits() {
	...
	return ' <a href=" '. site_url() .' ">'. get_bloginfo( 'name' ).'</a> [footer_copyright] • <a href="' . site_url() . '/about/">About</a> &nbsp; <a href="' . site_url() . '/contact/">Contact</a> &nbsp; <a href="' . site_url() . '/legals">Legals</a> &nbsp;<a href="' . site_url() . '/archive">Archive</a>  • [footer_loginout] •  Powered by <a href="http://www.duellingpixels.com" target="_blank">Duelling Pixels</a> ' ; 
